...
export OPENHANDS_COVERAGE_REPORT_PATH="{{COVERAGE_REPORT_PATH}}"
...
coverage_path = os.getenv("OPENHANDS_COVERAGE_REPORT_PATH", "").strip()

if enabled and host and pk and sk and trace_id and coverage_path and os.path.exists(coverage_path):
  line_rate = None
